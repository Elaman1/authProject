                                ...
                                <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="info-card-text flex-1">
                                            ...
                                            <?php
                                                ...
                                                <i class="fal fa-angle-down d-inline-block ml-1 fs-md"></i>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="edit.php?userID=<?php echo $user['ID'] ?>">
                                                            <i class="fa fa-edit"></i>
                                                            Редактировать</a>
                                                        <a class="dropdown-item" href="security.php?userID=<?php echo $user['ID'] ?>">
                                                            <i class="fa fa-lock"></i>
                                                            Безопасность</a>
                                                        <a class="dropdown-item" href="status.php?userID=<?php echo $user['ID'] ?>">
                                                            <i class="fa fa-sun"></i>
                                                            Установить статус</a>
                                                        <a class="dropdown-item" href="media.php?userID=<?php echo $user['ID'] ?>">
                                            ...
                                            <span class="text-truncate text-truncate-xl"><?php echo $user['Workspace'] ?></span>
                                        </div>
